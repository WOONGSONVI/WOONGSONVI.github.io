...
예를 들어 아래와 같이 초기값이 2인 $W$와 $Z = 3 \times W + 1$ 관계인 $Z$가 있습니다. z.backward()를 이용하여 미분값을 구했을 때, w.grad()를 보면 계속하여 기울기인 3이 누적하여 더해지는 것을 볼 수 있습니다. 따라서 초기화를 해주는 함수인 optimizer.zero_grad()가 필요합니다.
